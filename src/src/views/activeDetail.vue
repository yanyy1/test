<template>
    <div>
        ...
        <div class="viewDetailBtn thin-border-top" v-if="data.carId">
            ...
            <button class='viewDetail btn' v-on:click="submitBtn">查看车辆详情</button>
        </div>
...
<script>
    export default{
        ...
        methods:{
            submitBtn(){
                this.$router.push({path: '/carDetail/'+this.data.carId});
            },
            getData(){
                this.$http.get(BASE_URL + '/app/v1/banners/'+this.$route.params.id).then(function(res){
