...
export default {
    ...
    methods: {
        initOrder: function () {
            ...
            this.$http.get(BASE_URL+'app/v1/order/getOrderByPhoneNumberAndStatus?phoneNumber=' + username + '&status=2', { headers: { access_token: token } }).then((res) => {
                //根据电话号码获取订单信息
        ...
        target: function (index) {
            ...
            this.$router.push({ path: "carParticulars", query: { state: state, carId: carId,orderId: orderId } });
        }
    },
    computed: {
